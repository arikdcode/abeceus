...
- Private landing pads for shuttle traffic
- Underground conference facilities with advanced security
- Multiple fine dining establishments
- Recreation facilities (pools, yacht harbor, spa complexes)
- A small supporting town (population ~3,000) in the nearby valley
...
The resort is located on the Azure Coast of Atruna's western continent, approximately 800 km from the capital. The coastline features:
- White sand beaches extending for 15 km
- Dramatic limestone cliffs rising 200 meters above the sea
- Sheltered bay ideal for yacht mooring
- Temperate climate with mild winters
- Rich marine ecosystem (formerly a tourist attraction)

The nearby town of Clearwater Valley, built to support the resort, is also within the quarantine zone. It was a picturesque settlement built into the hillside overlooking the coast.

## Notable Features

### The Grand Atrium

The centerpiece of the main hotel, a 12-story open atrium with glass ceiling. This was where the first cases were identified. Images of the abandoned atrium, with furniture still arranged and crystal chandeliers hanging overhead, have become iconic.

### The Clifftop Villas

A series of ultra-exclusive villas built into the cliffside, accessible only by private funicular. Several high-ranking diplomats and corporate executives died in these villas. Their contents remain as they were left.

### The Underground Conference Complex

Known as "The Vault," this secure facility was built to host sensitive negotiations. It featured advanced security, soundproofing, and signal isolation. The complex is rumored to contain evidence about the outbreak that was never officially recovered.
