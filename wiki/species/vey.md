...
Builders of [[locations/oziri/index|Oziri's]] planetary shell and the ancient **transit lattice** that modern humans only partially exploit.
...
1. **Boundaries create meaning**
2. **Stability enables growth**
3. **Uncontained novelty is contamination**
...
1. **Anchor/stability cage** — Creates boundary conditions for lattice endpoints
