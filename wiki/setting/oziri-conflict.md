...
The [[species/vey|Vey]]-built planetary shell made orbital bombardment futile:
...
| Feature | Effect |
|---------|--------|
| Chaotic twists and turns | Prevented coordinated movement |
| Engineered diffractive wall surfaces | Broke up signals, turned long-range detection into pure noise |
| Fractal tunnel networks | Pirates could escape through one hole when flushed from another |
| Defenders knew the terrain | Attackers walked in blind |

**The Fighting:**

- [[military/atruna|Atrunean marines]] in power armor faced a seemingly unending series of **killboxes**
