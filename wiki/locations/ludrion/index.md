...
|---------|----------|--------------------|
| **[[factions/nuilea|Nuilea]]** | Large | Fully diversified; focus on high-volume extraction & heavy foundries; [[projects/janus|Janus II]] (Secretive). |
| **[[factions/mesulea|Mesulea]]** | Large | Fully diversified; focus on advanced materials & precision refining; MLE Naval consulate & security. |
| **[[factions/atruna|Atruna]]** | Medium | Specialized; focus on logistical services, finance, & high-value trade; notable industrial gaps. |
| **[[factions/freeholds|Freeholds]]** | Minor | Niche; independent small-scale extraction & salvage; significant reliance on major power infrastructure. |
| **[[factions/oziri-council|Oziri]]** | Unofficial | Shadow ops; black market siphoning; operations typically **masquerade** as other factions or rogue contractors. |
...
The largest and most industrial of the op-centers. Bastion Sol is a massive, heavily armored subterranean complex built into a deep equatorial canyon. It is the heart of Nuilea's Ludrion operations and the secret testing ground for [[projects/janus|Janus II]].
...
*See also: [[projects/janus|Project Janus II]], [[setting/economy/nuilea-economy|Nuilean Economy]]*
