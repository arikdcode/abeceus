---
title: Cognition Augmentation Devices
tags:
  - technology
  - augmentation
  - cads
...
1. **Mind Machine Interface (MMI)** — Hardware attached to the brain with read/write capabilities and low-level routing software

2. **Biologically Compatible Microchip (BCM)** — The substrate the CMI runs on

3. **Cognitive Modeling Intelligence (CMI)** — An AI that monitors and interprets brain activity, providing an API for software to interact with the mind
